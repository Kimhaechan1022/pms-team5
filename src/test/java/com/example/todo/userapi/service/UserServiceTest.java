...
class UserServiceTest {
    ...
    void validateEmailTest() {
        // given
        UserSignUpRqDto dto = UserSignUpRqDto.builder()
    ...
    void createTest() {
        ...
        //when
        UserSignUpRsDto responseDTO = userService.create(dto);
        //then
    ...
    void loginTest() {
        ...
        //when
        LoginRsDto loginUser = userService.getByCredentials(email, password);
        //then

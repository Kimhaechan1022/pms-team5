...
public class UserService {
    ...
    // 회원가입 처리
    public UserSignUpRsDto create(final UserSignUpRqDto userSignUpDTO) {
        ...
        return new UserSignUpRsDto(savedUser);
    }
    ...
    // 로그인 검증
    public LoginRsDto getByCredentials(
            final String email,
        ...
        return new LoginRsDto(originalUser, token);
    }

...
public class UserApiController {
    ...
    public ResponseEntity<?> signUp(
            @Validated @RequestBody UserSignUpRqDto signUpDTO
    ...
    public ResponseEntity<?> signIn(
            @Validated @RequestBody LoginRqDto requestDTO) {

        try {
            LoginRsDto userInfo = userService.getByCredentials(
                    requestDTO.getEmail(),
